...
% Description:
%   test AR imputation results
%   First, randomly remove rr for high quality signal (firstbeat)
%   impute using AR
%   calculate error between imputed values and original removed values
%   plot histogram of repeated runs
% Dependencies:
%   internal: generate_miss_value_signal, find_outliers, impute, plot_prediction, get_prediction_error
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


clear all;

% read original rr signal
